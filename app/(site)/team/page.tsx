...
const TeamSection = ({ title, members }) => (
  <div className="mt-10">
<h2 className="text-2xl font-bold mb-6 pb-2 px-2 dark:border-b-4 dark:border-gray-700 text-gray-800 dark:text-gray-100 shadow-lg tracking-wide rounded-lg">
  {title}
</h2>
      ...
      {members.map((member) => (
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="relative mx-auto -mt-12 h-24 w-24 overflow-hidden rounded-full border-4 border-white dark:border-gray-800">
              <Image
  ...
  return (
    <div className="mt-10 min-h-screen pt-16 text-gray-900 transition-colors duration-300 dark:text-gray-100">
      <div className="container mx-auto p-4">
        <div>
          <p className="text-gray-500 text-sm text-left font-normal pb-3 dark:text-gray-400">OUR TEAM</p>
          <h1 className="xl:text-lg text-md text-left text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 dark:text-gray-100">
        ...
        <TeamSection title="Interns" members={interns} />
      </div>
    </div>
  );
};
