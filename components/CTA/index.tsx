          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Andhra Angels Today & Empower Your Startup Journey
              </h2>
              <p>
                Connect with experienced angel investors and gain the support you need to turn your innovative ideas into successful businesses. Join our community and start your entrepreneurial journey today.
              </p>
            </motion.div>
            <motion.div
              variants={{
