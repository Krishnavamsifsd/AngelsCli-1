              ...
              >
                ...
                >
                  <Image
                    ...
                    width={150} // These props are still required for Next.js Image component
                    height={50}
                  />
                </a>
                ...
                <p className="mb-1.5 text-sectiontitle uppercase tracking-[5px] text-lg">
  Contact
</p>
<a
  href="mailto:ceo@andhrangels.in"
  className="text-itemtitle font-medium text-black dark:text-white text-lg"
>
  ceo@andhrangels.in
</a>
              </motion.div>

            <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-8 lg:w-2/3 xl:w-7/12">
  <motion.div
    variants={{
      hidden: {
        opacity: 0,
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Andhra angel networks. All rights reserved
              </p>
            </motion.div>
  ...
  <li>
    <a href="https://www.youtube.com/@AndhraAngelNetworks" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
      ...
      >
        <path
          d="M23.498 6.186a2.999 2.999 0 0 0-2.112-2.12C19.8 3.5 12 3.5 12 3.5s-7.8 0-9.386.566a2.999 2.999 0 0 0-2.112 2.12C0 7.8 0 12 0 12s0 4.2.502 5.814a2.999 2.999 0 0 0 2.112 2.12C4.2 20.5 12 20.5 12 20.5s7.8 0 9.386-.566a2.999 2.999 0 0 0 2.112-2.12C24 16.2 24 12 24 12s0-4.2-.502-5.814zM9.75 15.02V8.98L15.5 12l-5.75 3.02z"
          fill="currentColor"
        />
      </svg>
    </a>
  ...
  <li>
    <a href="https://x.com/AndhraAngels" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
      <svg
        className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
        width="24"
        height="24"
  ...
  <li>
    <a href="https://www.linkedin.com/in/andhraangelnetworks" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
      <svg
        className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
        width="24"
        height="24"
