...
const Integration = () => {
 ...
 <SectionHeader
  headerInfo={{
    title: `INTEGRATIONS`,
    subtitle: `Empowering Startups with Seamless Data Management.`,
    description: `At Andhra Angels, we provide robust integrations to help startups manage their data effortlessly. Our solutions enable real-time data access and control, ensuring you stay connected and efficient.`,
  }}
/>
